...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function hideItems() {
      [this.oldItems, this.newItems].forEach(function (itemON) {
        itemON.forEach(function (item, i, arr) {
          if (i !== arr.length - 1) {
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function autoplayA() {
      ...
      this.container.parentNode.addEventListener('mouseenter', function () {
        clearInterval(paused);
      });
      this.container.parentNode.addEventListener('mouseleave', function () {
        paused = setInterval(function () {
          return _this3.nextSlide();
        }, 5000);
      });
